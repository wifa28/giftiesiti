...
<br>
  <section class="ftco-section ftco-Keranjang Belanja">
                      ...
                      <table class="table">
                          ...
                          <tbody>
                            ...
                            <tr class="text-center cart-<?php echo $item['rowid']; ?>">
                              <td class="product-remove"><a href="#" class="remove-item" data-rowid="<?php echo $item['rowid']; ?>">X<span class="ion-ios-close"></span></a></td>
          ...
          <?php else : ?>
            <div class="row">
              <div class="col-md-12 ftco-animate">
                <div class="alert alert-info">Tidak ada barang dalam keranjang.<br><?php echo anchor('customer', 'Jelajahi produk kami'); ?> dan mulailah berbelanja!</div>
              </div>
            </div>
          <?php endif; ?>
          </div>
