      ...
      <div class="container">
          <div class="row">
              ...
              <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                ...
                <div class="w-100"></div>
                <div class="col-md-12">
                    <p style="color: #000;">Tersedia <?php echo $product->stock; ?></p>
                </div>
            </div>
      ...
      <div class="container">
          <div class="row">
              ...
              <div class="col-md-6 col-lg-3 ftco-animate">
                  <div class="product">
                      <a href="<?php echo site_url('shop/product/'. $product->id .'/'. $product->sku .'/'); ?>" class="img-prod"><img class="img-fluid" src="<?php echo base_url('assets/uploads/products/'. $product->picture_name); ?>" alt="<?php echo $product->name; ?>">
                          <!-- <?php if ($product->current_discount > 0) : ?>
