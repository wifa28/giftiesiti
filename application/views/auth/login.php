...
<html lang="id-ID">
    ...
    <body>
        ...
        <div class=" w3l-login-form">
            ...
            <div>
                <p>Belum Terdaftar? 
                <a href="<?php echo site_url('auth/register'); ?>"> Sign Up</a> or <a href="<?php echo base_url(); ?>"> Back</a></p>
            </div>
        </div>
        </div>
        <footer>
            <p class="copyright-agileinfo"> &copy; 2021 GIFTIESITI</p>
        </footer>
