...
class Order_model extends CI_Model
{
    ...
    public function get_all_orders($limit, $start, $search = null)
    {
        ...
        $this->db->select('o.id, o.order_number, o.order_date, o.order_status, o.payment_method, o.total_price, o.total_items, cu.name AS customer')
    ...
    public function latest_orders()
    {
        $orders = $this->db->query("
            SELECT o.id, o.order_number, o.order_date, o.order_status, o.payment_method, o.total_price, o.total_items, cu.name AS customer
            FROM orders o
            JOIN customers cu
    ...
    {
        $data = $this->db->query("
            SELECT o.*, p.id as payment_id, p.payment_price, p.payment_date, p.picture_name, p.payment_status, p.confirmed_date, p.payment_data
            FROM orders o
    ...
    {
        $orders = $this->db->query("
            SELECT oi.*, o.id as order_id, o.order_number, o.order_date, c.name
            FROM order_items oi
            JOIN orders o
	            ON o.id = oi.order_id
            JOIN customers c
