...
class Customers extends CI_Controller {
    public function __construct()
    {
        ...
        $this->load->model(array(
            'admin/customer_model' => 'customer',
            'admin/order_model' => 'order',
            'admin/payment_model' => 'payment'
        ));
    }
    ...
    public function index()
    {
        ...
        $this->load->view('themes/admin/customers/customers');
    ...
    public function view($id = 0)
    {
        if ( $this->customer->is_customer_exist($id))
        {
            ...
            $this->load->view('themes/admin/header', $params);
            $this->load->view('themes/admin/customers/view', $customer);
            $this->load->view('themes/admin/footer');
        }
        else
        {
