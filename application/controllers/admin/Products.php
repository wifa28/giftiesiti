...
class Products extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->load->view('themes/admin/header', $params);
        $this->load->view('themes/admin/products/products', $products);
    ...
    public function search()
    {
        ...
        $this->load->view('themes/admin/header', $params);
        $this->load->view('themes/admin/products/search', $products);
        $this->load->view('themes/admin/footer');
    }
    ...
    public function add_new_product()
    {
        ...
        $this->load->view('themes/admin/header', $params);
        $this->load->view('themes/admin/products/add_new_product', $product);
        $this->load->view('themes/admin/footer');
    }
    ...
    public function edit($id = 0)
    {
        if ( $this->product->is_product_exist($id))
        {
            ...
            $this->load->view('themes/admin/header', $params);
            $this->load->view('themes/admin/products/edit_product', $product);
            $this->load->view('themes/admin/footer');
        }
        else
        {
    ...
    public function view($id = 0)
    {
        if ( $this->product->is_product_exist($id))
        {
            ...
            $this->load->view('themes/admin/header', $params);
            $this->load->view('themes/admin/products/view', $product);
            $this->load->view('themes/admin/footer');
        }
        else
        {
    ...
    public function category()
    {
        ...
        $this->load->view('themes/admin/header', $params);
        $this->load->view('themes/admin/products/category', $categories);
        $this->load->view('themes/admin/footer');
    }
    ...
    public function coupons()
    {
        ...
        $this->load->view('themes/admin/header', $params);
        $this->load->view('themes/admin/products/coupons');
        $this->load->view('themes/admin/footer');
    }
