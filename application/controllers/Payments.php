...
class Payments extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->load->view('themes/payments/payments', $payments);
    ...
    public function confirm()
    {
        ...
        $this->load->view('themes/customer/header', $params);
        $this->load->view('themes/payments/confirm', $payments);
        $this->load->view('themes/customer/footer');
    }
    ...
    public function view($id = 0)
    {
        if ( $this->payment->is_payment_exist($id))
        {
            ...
            $this->load->view('themes/customer/header', $params);
            $this->load->view('themes/payments/view', $payment);
            $this->load->view('themes/customer/footer');
        }
        else
        {
